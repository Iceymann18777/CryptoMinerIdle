...
.method private BuildNotification(Landroid/content/Context;Lcom/hippogames/simpleandroidnotifications/NotificationParams;Landroid/content/Intent;Landroid/app/NotificationManager;)Landroid/app/Notification;
    ...
    invoke-virtual {p4, v7}, Landroid/app/NotificationManager;->getNotificationChannel(Ljava/lang/String;)Landroid/app/NotificationChannel;
    ...
    iget-object v8, p2, Lcom/hippogames/simpleandroidnotifications/NotificationParams;->ChannelId:Ljava/lang/String;

    iget-object v9, p2, Lcom/hippogames/simpleandroidnotifications/NotificationParams;->ChannelName:Ljava/lang/String;

    iget v10, p2, Lcom/hippogames/simpleandroidnotifications/NotificationParams;->Importance:I
    ...
    .line 292
    invoke-virtual {v7, v6}, Landroid/app/NotificationChannel;->setLockscreenVisibility(I)V
    ...
    .line 302
    invoke-virtual {v7, v8, v9}, Landroid/app/NotificationChannel;->setSound(Landroid/net/Uri;Landroid/media/AudioAttributes;)V

    .line 305
    :cond_0
    invoke-virtual {p4, v7}, Landroid/app/NotificationManager;->createNotificationChannel(Landroid/app/NotificationChannel;)V
    ...
    iget-object v8, p2, Lcom/hippogames/simpleandroidnotifications/NotificationParams;->Message:Ljava/lang/String;

    invoke-virtual {p3, v8}, Landroid/app/Notification$BigTextStyle;->bigText(Ljava/lang/CharSequence;)Landroid/app/Notification$BigTextStyle;
    ...
    invoke-virtual {v0, p3, v9, v8}, Landroid/content/res/Resources;->getIdentifier(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)I
    ...
    iget v5, p2, Lcom/hippogames/simpleandroidnotifications/NotificationParams;->LightOffMs:I

    invoke-virtual {v1, p3, v0, v5}, Landroid/app/Notification$Builder;->setLights(III)Landroid/app/Notification$Builder;
...
.method private CreateStackedNotification(Landroid/content/Context;Landroid/content/Intent;Lcom/hippogames/simpleandroidnotifications/NotificationParams;)V
    ...
    invoke-virtual {v4, v1, v7, v6}, Landroid/content/res/Resources;->getIdentifier(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)I
